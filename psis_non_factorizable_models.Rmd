...
Below, we will explain how to perform leave-one-out cross-validation for a
lagged simultaneously autoregressive model applied to data of Neighborhood Crime
in Columbus, Ohio [cite].
