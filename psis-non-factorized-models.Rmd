...
abstract: |
  ...
  model with a multivariate normal or Student-$t$ outcome model. We demonstrate
  the method using lagged simultaneously autoregressive (SAR) models as a case
  study.
  \linebreak\linebreak 
...
pointwise models/likelihoods for each observation. However, many important
...
The matrix $W$ has entries $w_{ii} = 0$ along the diagonal and the off-diagonal entries $w_{ij}$
