...
schematically. Black retangles depict manifest variables, that is, observed
response values. Black circles depict latent variables and parameters. Blue
rectangles indicate a joint prior over the surronded variables. (a)
Conditionally independent responses given hyperparameters (e.g., a linear
regression model). (b) Conditionally dependent responses with a Markove property
