...
abstract: |
  ...
  cross-validation (LOO-CV) requires the observation models can be factorized to simple terms, but many
  ...
  multivariate normal or Student-$t$ model. In a case study, we demonstrate
...
model, and then the likelihood is also the product of the pointwise
